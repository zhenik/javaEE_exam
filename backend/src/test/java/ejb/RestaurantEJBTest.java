...
public class RestaurantEJBTest extends EjbTestBase  {
    ...
    @Test
    public void testCanCreateADish(){
        //Arrange
    ...
    @Test
    public void testCreateDish_dishAlreadyExists(){
        //Arrange
        String dishName = "dishName";
        String dishDescription = "dishDescription";
    ...
    @Test
    public void testCreateADishWithWrongId(){
    ...
    @Test
    public void testCreateADishWithEmptyDescription(){
